...
public class ListLoadingIndicatorViewHolder extends RecyclerView.ViewHolder {
    ...
    public static ListLoadingIndicatorViewHolder create(LayoutInflater inflater, ViewGroup container) {
        return new ListLoadingIndicatorViewHolder(inflater.inflate(R.layout.smp_view_list_loading_indicator,
            container, false));
    }
}
