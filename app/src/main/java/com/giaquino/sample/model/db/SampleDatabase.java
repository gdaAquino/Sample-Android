...
public class SampleDatabase extends SQLiteOpenHelper implements Database {
    ...
    @Override
    public Cursor query(String table, String selection, String[] selectionArgs, String groupBy, String having, String orderBy) {
        return database.query(table, null, selection, selectionArgs, groupBy, having, orderBy);
    }

    @Override
    public int insert(String table, List<ContentValues> contentValues) {
